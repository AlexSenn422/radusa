...
templates.register('Customer Addresses Template', 'template-addresses', {
  onLoad: function(container) {
    ...
    var $editAddressContainers = $(selectors$3.editAddressContainer, $container);
  ...
  _populateProvinceSelect: function($provinceSelect, provinces, defaultValue) {
...
templates.register('Customer Login Template', 'template-login', {
  onLoad: function(container) {
    var $container = (this.$container = $(container));
...
sections.register('collection-template', {
  ...
  onFilterChange: function() {
    ...
    document.location.href = this.filter + search;
  },
...
Slider.prototype = $.extend({}, Slider.prototype, {
  ...
  _onTouchMove: function(evt) {
    ...
    this.percentMoved =
      (this.currentPosition.x - this.startPosition.x) / this.windowWidth * 100;
